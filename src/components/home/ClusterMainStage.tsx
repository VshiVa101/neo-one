    ...
    <div className="w-full max-w-[92vw] md:max-w-none flex flex-row items-center lg:items-start gap-3 lg:gap-[2vw]">
      <AnimatePresence mode="wait">
        <motion.div
          ...
          whileHover={{ scale: 1.05, rotate, y: -5 }}
          transition={{ duration: 0.6, ease: [0.32, 0.72, 0, 1] }}
          onClick={onClick}
          className="w-[45vw] h-[45vw] md:w-[18vw] md:h-[18vw] max-w-[220px] max-h-[220px] md:max-w-none md:max-h-none flex-shrink-0 overflow-hidden shadow-[0_0_40px_rgba(0,0,0,0.7)] cursor-pointer relative"
        >
          <Image
            src={cluster.image}
            alt={cluster.title}
