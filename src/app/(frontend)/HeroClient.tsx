...
export default function HeroClient() {
  ...
  return (
    <>
      <AnimatePresence>
        {!isUnlocked && <MatrixGateway onClick={handleUnlock} isFading={isFading} />}
      </AnimatePresence>
      ...
      >
        ...
        <div
          className={`fixed inset-0 z-10 w-full h-screen pointer-events-auto transition-opacity duration-1000 ${isEyeReady ? 'opacity-100' : 'opacity-0'}`}
        >
          <EyeScene
            targetRoute="/home"
